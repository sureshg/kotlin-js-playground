              ...
              connector =
                  RSocketConnector {
                    ...
                    connectionConfig {
                      keepAlive =
                          KeepAlive(
                              interval = Duration.seconds(30), maxLifetime = Duration.minutes(2))
                      payloadMimeType =
                          PayloadMimeType(data = "application/json", metadata = "application/json")
                    }
...
data class Model(
  ...
  @kotlinx.serialization.Serializable data class Nested(val numberCast: Int)
}
